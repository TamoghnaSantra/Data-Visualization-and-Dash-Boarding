...
anim <- ggplot (my_dat, aes(x=Category, y = Value, fill=City))+
...
p <- ggplot (my_dat, aes(x=Company, y = Output, fill=Company))+
  geom_boxplot()
...
###PUT YOUR ggplotly() figure here. It will compile in the R Markdown report.
ggplotly(
  ggplot (dat3, aes(x=Category, y = Quantity, frame = Time, ids = Category))+
  geom_point()+
