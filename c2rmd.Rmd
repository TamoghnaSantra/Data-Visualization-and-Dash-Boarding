...
table (Gender)
ggplot(cel, aes(x = dwnom1, y = all_pass, shape = Gender, colour = Gender)) +
  geom_point()+
...
Gender = recode(cel$female, '0' = "Male", '1' = "Female")
cel_mod = cel %>%
  mutate(majority = recode(majority, "0" = "Majority", "1" = "Minority"))
ggplot(cel_mod, aes(x = votepct, y = all_pass, shape = Gender, colour = Gender)) +
  geom_point()+
...
cel_mod = cel %>%
  mutate(majority = recode(majority, "0" = "Majority", "1" = "Minority"))
ggplot(cel_mod, aes(x = majority, y = les, group_by(Majority))) +
  geom_boxplot()+
