...
boxplot(dat$faminc_new, main = "Tamoghna's box-plot of Family Income", xlab = "Family Income")
...
dat2 <- filter(dat, gender == 1, (region == 1 | region == 2), marstat == 1, newsint == 1)
str(dat2)
