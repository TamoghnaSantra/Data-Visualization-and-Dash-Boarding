...
ggplot(dat4, aes(x=var1, y = reorder(names,var1)))+
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        panel.grid.major.y = element_line(linetype = "dashed", colour = "orange"))+
  labs(x="Variable 1", y = "")
...
ggplot(dat5, aes(x=reorder(names,var1), y = var1))+
  ...
  geom_segment(aes(x=names,xend=names,y = 0, yend=var1), color = "green4")+
...
####PUT YOUR CODE HERE
pie(pie_dat, labels = c("1","2","3","4","5"), border="black", col=my_color )
